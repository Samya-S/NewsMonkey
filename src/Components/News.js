...
export class News extends Component {
  ...
  async updateNews(pgNo){
    ...
    const fetchURL = `https://newsapi.org/v2/top-headlines?country=${this.props.country}&category=${this.props.category}&apiKey=${this.props.apiKey}&page=${pgNo}&pageSize=${this.props.pageSize}`
  ...
  fetchMoreData = async () => {
    const fetchURL = `https://newsapi.org/v2/top-headlines?country=${this.props.country}&category=${this.props.category}&apiKey=${this.props.apiKey}&page=${this.state.page + 1}&pageSize=${this.props.pageSize}`
    // this.setState({loading: true})
    let data = await fetch(fetchURL);
    let parsedData = await data.json();
    console.log(parsedData);
